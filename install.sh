...
function check_download {
    ...
    if [ ! -d "${FRIX_CONFIG_PATH}" ]; then
        ...
        if git -C $frixtemppath clone -b $frixbranchname https://github.com/BTomiii/klippain.git $frixreponame; then
...
wget -O - https://raw.githubusercontent.com/BTomiii/klippain-shaketune/BTT_Eddy/install.sh | bash
